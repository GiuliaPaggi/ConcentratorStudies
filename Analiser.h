...
Analiser::Analiser(TTree *tree) : fChain(0) {
  ...
  if (tree == 0) {
    ...
    TDirectory *dir =
        (TDirectory *)f->Get("DTDPGNtuple_12_4_SingleMu_20-100pT_Eta1p25.root:/dtNtupleProducer");
...
void Analiser::Init(TTree *tree) {
  ...
  fChain->SetBranchAddress("environment_truePileUp", &environment_truePileUp,
                           &b_environment_truePileUp);
  fChain->SetBranchAddress("environment_actualPileUp", &environment_actualPileUp,
                           &b_environment_actualPileUp);
  ...
  fChain->SetBranchAddress("seg_posLoc_x_midPlane", &seg_posLoc_x_midPlane,
                           &b_seg_posLoc_x_midPlane);
  ...
  fChain->SetBranchAddress("seg_phiHits_superLayer", &seg_phiHits_superLayer,
                           &b_seg_phiHits_superLayer);
  ...
  fChain->SetBranchAddress("ph2Seg_posLoc_x_midPlane", &ph2Seg_posLoc_x_midPlane,
                           &b_ph2Seg_posLoc_x_midPlane);
  ...
  fChain->SetBranchAddress("ph2Seg_phiHits_posErr", &ph2Seg_phiHits_posErr,
                           &b_ph2Seg_phiHits_posErr);
  ...
  fChain->SetBranchAddress("ph2Seg_phiHits_wirePos", &ph2Seg_phiHits_wirePos,
                           &b_ph2Seg_phiHits_wirePos);
  fChain->SetBranchAddress("ph2Seg_phiHits_layer", &ph2Seg_phiHits_layer, &b_ph2Seg_phiHits_layer);
  fChain->SetBranchAddress("ph2Seg_phiHits_superLayer", &ph2Seg_phiHits_superLayer,
                           &b_ph2Seg_phiHits_superLayer);
  fChain->SetBranchAddress("ph2Seg_phiHits_time", &ph2Seg_phiHits_time, &b_ph2Seg_phiHits_time);
  fChain->SetBranchAddress("ph2Seg_phiHits_timeCali", &ph2Seg_phiHits_timeCali,
                           &b_ph2Seg_phiHits_timeCali);
  ...
  fChain->SetBranchAddress("ph2Seg_zHits_timeCali", &ph2Seg_zHits_timeCali,
                           &b_ph2Seg_zHits_timeCali);
  ...
  fChain->SetBranchAddress("ltTwinMuxIn_dirLoc_phi", &ltTwinMuxIn_dirLoc_phi,
                           &b_ltTwinMuxIn_dirLoc_phi);
  ...
  fChain->SetBranchAddress("ltTwinMuxOut_posLoc_x", &ltTwinMuxOut_posLoc_x,
                           &b_ltTwinMuxOut_posLoc_x);
  fChain->SetBranchAddress("ltTwinMuxOut_dirLoc_phi", &ltTwinMuxOut_dirLoc_phi,
                           &b_ltTwinMuxOut_dirLoc_phi);
  ...
  fChain->SetBranchAddress("ltTwinMuxInTh_station", &ltTwinMuxInTh_station,
                           &b_ltTwinMuxInTh_station);
  ...
  fChain->SetBranchAddress("ph2TpgPhiHw_superLayer", &ph2TpgPhiHw_superLayer,
                           &b_ph2TpgPhiHw_superLayer);
  ...
  fChain->SetBranchAddress("ph2TpgPhiHw_dirLoc_phi", &ph2TpgPhiHw_dirLoc_phi,
                           &b_ph2TpgPhiHw_dirLoc_phi);
  ...
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_nTrigs", &ph2TpgPhiEmuHb_nTrigs,
                           &b_ph2TpgPhiEmuHb_nTrigs);
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_wheel", &ph2TpgPhiEmuHb_wheel, &b_ph2TpgPhiEmuHb_wheel);
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_sector", &ph2TpgPhiEmuHb_sector,
                           &b_ph2TpgPhiEmuHb_sector);
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_station", &ph2TpgPhiEmuHb_station,
                           &b_ph2TpgPhiEmuHb_station);
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_quality", &ph2TpgPhiEmuHb_quality,
                           &b_ph2TpgPhiEmuHb_quality);
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_superLayer", &ph2TpgPhiEmuHb_superLayer,
                           &b_ph2TpgPhiEmuHb_superLayer);
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_rpcFlag", &ph2TpgPhiEmuHb_rpcFlag,
                           &b_ph2TpgPhiEmuHb_rpcFlag);
  ...
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_posLoc_x", &ph2TpgPhiEmuHb_posLoc_x,
                           &b_ph2TpgPhiEmuHb_posLoc_x);
  fChain->SetBranchAddress("ph2TpgPhiEmuHb_dirLoc_phi", &ph2TpgPhiEmuHb_dirLoc_phi,
                           &b_ph2TpgPhiEmuHb_dirLoc_phi);
  ...
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_nTrigs", &ph2TpgPhiEmuAm_nTrigs,
                           &b_ph2TpgPhiEmuAm_nTrigs);
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_wheel", &ph2TpgPhiEmuAm_wheel, &b_ph2TpgPhiEmuAm_wheel);
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_sector", &ph2TpgPhiEmuAm_sector,
                           &b_ph2TpgPhiEmuAm_sector);
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_station", &ph2TpgPhiEmuAm_station,
                           &b_ph2TpgPhiEmuAm_station);
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_quality", &ph2TpgPhiEmuAm_quality,
                           &b_ph2TpgPhiEmuAm_quality);
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_superLayer", &ph2TpgPhiEmuAm_superLayer,
                           &b_ph2TpgPhiEmuAm_superLayer);
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_rpcFlag", &ph2TpgPhiEmuAm_rpcFlag,
                           &b_ph2TpgPhiEmuAm_rpcFlag);
  ...
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_posLoc_x", &ph2TpgPhiEmuAm_posLoc_x,
                           &b_ph2TpgPhiEmuAm_posLoc_x);
  fChain->SetBranchAddress("ph2TpgPhiEmuAm_dirLoc_phi", &ph2TpgPhiEmuAm_dirLoc_phi,
                           &b_ph2TpgPhiEmuAm_dirLoc_phi);
  ...
  fChain->SetBranchAddress("tfBmtfOut_matchedTpIdx", &tfBmtfOut_matchedTpIdx,
                           &b_tfBmtfOut_matchedTpIdx);
  ...
  fChain->SetBranchAddress("ph2TpgThetaHw_station", &ph2TpgThetaHw_station,
                           &b_ph2TpgThetaHw_station);
  fChain->SetBranchAddress("ph2TpgThetaHw_quality", &ph2TpgThetaHw_quality,
                           &b_ph2TpgThetaHw_quality);
  fChain->SetBranchAddress("ph2TpgThetaHw_rpcFlag", &ph2TpgThetaHw_rpcFlag,
                           &b_ph2TpgThetaHw_rpcFlag);
  ...
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_nTrigs", &ph2TpgThetaEmuAm_nTrigs,
                           &b_ph2TpgThetaEmuAm_nTrigs);
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_wheel", &ph2TpgThetaEmuAm_wheel,
                           &b_ph2TpgThetaEmuAm_wheel);
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_sector", &ph2TpgThetaEmuAm_sector,
                           &b_ph2TpgThetaEmuAm_sector);
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_station", &ph2TpgThetaEmuAm_station,
                           &b_ph2TpgThetaEmuAm_station);
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_quality", &ph2TpgThetaEmuAm_quality,
                           &b_ph2TpgThetaEmuAm_quality);
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_rpcFlag", &ph2TpgThetaEmuAm_rpcFlag,
                           &b_ph2TpgThetaEmuAm_rpcFlag);
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_chi2", &ph2TpgThetaEmuAm_chi2,
                           &b_ph2TpgThetaEmuAm_chi2);
  ...
  fChain->SetBranchAddress("ph2TpgThetaEmuAm_index", &ph2TpgThetaEmuAm_index,
                           &b_ph2TpgThetaEmuAm_index);
  Notify();
}
